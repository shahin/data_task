...
module Rake
  module DataTask
    ...
    class Sql
      ...
      # @return [Object] the return value of &type_logic on the value in r
      ...
      # @return [Integer] the single result converted to an Integer
      ...
      #
      # @param r [Array] an array containing a single result from a query
      # @return [Time] the single result converted to Ruby's local time
      ...
      # Get a single boolean via SQL.
      #
      # @param r [Array] an array containing a single result from a query
      # @return [Boolean] the single result converted to a Ruby boolean
      def self.get_single_bool r
        parse_single_value r do
          b = r.first.first
          true?(b)
        end
